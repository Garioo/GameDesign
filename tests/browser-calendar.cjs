...
(async()=>{
 ...
 await page.goto((process.env.APP_URL || 'http://localhost:3000')+'/calendar');
 ...
 console.log('Calendar passed: standalone event create/reload/edit/delete, board tasks are untouched, month navigation and mobile layout.');
